...
<body>
    <div class="row">
       <a href="index.html"> <h2 align="center">Expense Tracker By TKH</h2> </a>
        <hr>
                    ...
                    <form role="form" method="post" name="register" onsubmit="return checkpass();">
                        ...
                        <fieldset>
                            ...
                            <div class="checkbox">
								...
								<span> <a href="index.html"  class="btn btn-primary">Home</a></span>
                                <div class="pull-right">
                                    <span><a href="login.php" class="btn btn-primary">Login</a></span>
